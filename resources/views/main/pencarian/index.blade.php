...
<div class="card-header d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
    <h5 class="card-title m-0 me-2 h5"><i class='menu-icon bx bx-file-find'></i> Hasil pencarian</h5>
    <a href="/admin/dashboard" class="btn btn-primary mt-2 mt-md-0"><i class='menu-icon bx bx-left-arrow-alt' ></i> Kembali</a>
</div>
